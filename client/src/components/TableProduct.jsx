...
//               Qty
//             </th>
//             <th scope="col" className="bg-dark text-light cursor-pointer">
//               Qty++
//             </th>
//             <th scope="col" className="bg-dark text-light cursor-pointer">
//               Qty--
      ...
      <table className="table table-bordered border-primary bg-dark text-center">
        <thead>
          <tr>
            ...
            <th scope="col" className="bg-dark text-light" style={pointerStyle}>Qty++</th>
            <th scope="col" className="bg-dark text-light" style={pointerStyle}>Qty--</th>
            <th scope="col" className="bg-dark text-light" style={pointerStyle}>Remove</th>
          </tr>
        </thead>
        <tbody>
          {cart?.items?.map((product) => (
